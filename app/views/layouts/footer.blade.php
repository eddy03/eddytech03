<div class="container">
    <a href="{{ route('home') }}" class="blueme">eddytech03.com</a> oleh <a href="https://twitter.com/eddytech03" class="blueme">Edi Abdul Rahman</a>
    ...
    Kesemua contoh code adalah MIT.
    <span class="visible-xs">
        <br />
    </span>
